...
Vector currently bundles a [`lua` transform](https://help.shiftm.com/docs/reference/transforms/lua/), and there is ongoing
...
be familiar with the [Lua](https://help.shiftm.com/docs/reference/transforms/lua/) transform, WebAssembly is a bit different.
